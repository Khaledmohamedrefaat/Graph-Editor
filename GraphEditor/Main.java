...
public class Main extends Application{
    ...
    public void setMenu(){
        ...
        editEdge_btn.setOnAction(event -> {
            ...
            to[0] = toVertex_tf.getText();
            try {
                weights[0] = Integer.parseInt(weightVertex_tf.getText());
                graph.updateWeights(from, to, weights);
                Main.errorLabel.setText("");
                graph.draw();
            }
            catch (Exception e){
                Main.errorLabel.setText("Weight Must be an Integer");
                graph.draw();
            }
        ...
        menuLayout.getChildren().addAll(
                ...
                weightVertex_tf, editEdge_btn, errorLabel
        );
